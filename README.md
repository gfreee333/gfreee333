...
<!-- Заголовок №1 на всю ширину -->
  ...
  <div style="flex: 1; min-width: 250px; color: #c9d1d9; font-size: 16px; line-height: 1.6;">
    ...
    <p style="margin: 0 0 15px 0;">
      Мне нравится строить надёжные системы и разбираться в том, как они работают под капотом, 
  ...
  <div style="width: 100%; border-bottom: 2px solid #4493f8; padding-bottom: 10px; margin-bottom: 18px;">
    <h2 style="color: #4493f8; margin: 0; text-align: center; font-size: 1.5em;">
      🕮 Моя специализация
    </h2>
  </div>
...
<!-- Основной контейнер со значками -->
<div style="display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; align-items: center; padding: 10px 0;">
