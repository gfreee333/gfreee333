<div style="display: flex; flex-wrap: wrap; gap: 20px; margin: 20px 0; padding: 20px; background: #0d1117; border-radius: 8px; border: 1px solid #30363d;">
  <!-- ===== БАННЕР С ПАНДОЙ (БЕЗ <p>) ===== -->
  <div style="flex: 0 0 100%; border-bottom: 2px solid #4493f8; padding-bottom: 10px; margin-bottom: 10px;"></div>
  <div align="center" style="margin: 20px 0; padding: 10px; 
      background: linear-gradient(135deg, rgba(68, 147, 248, 0.1) 0%, rgba(13, 17, 23, 0.3) 100%);
      border-radius: 15px; 
      border: 1px solid rgba(68, 147, 248, 0.2);
      box-shadow: 0 4px 30px rgba(68, 147, 248, 0.15),
                  inset 0 0 30px rgba(68, 147, 248, 0.05);">
    <img src="https://raw.githubusercontent.com/gfreee333/gfreee333/main/image/header_panda.jpg" 
         width="100%" 
         style="border-radius: 12px; display: block;" 
         alt="Panda banner" />
  </div>
  <!-- ===== АНИМИРОВАННЫЙ ТЕКСТ ===== -->
  <div style="flex: 0 0 100%; border-bottom: 2px solid #4493f8; padding-bottom: 10px; margin-bottom: 10px;">
    <div align="center" style="margin: 20px 0; padding: 20px; 
         background-image: url('https://raw.githubusercontent.com/gfreee333/gfreee333/main/image/phone_animation_hello.jpg');
         ...
         min-height: 90px;
         box-shadow: inset 0 0 80px rgba(13, 17, 23, 0.85),
                     0 4px 30px rgba(68, 147, 248, 0.3);
         display: flex;
         align-items: center;
         justify-content: center;">
      <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&weight=700&size=32&duration=3500&pause=500&color=4493F8&center=true&vCenter=true&width=600&lines=Добро+пожаловать+на+мой+профиль;Чухманов Иван;Java-разработчик;" alt="Typing SVG" style="display: block; max-width: 100%;" />
    </div>
  </div>
  <!-- ===== БЛОК: О СЕБЕ ===== -->
  <div style="flex: 0 0 100%; border-bottom: 2px solid #4493f8; padding-bottom: 10px; margin-bottom: 10px;">
    <h2 align="center" style="color: #4493f8; margin: 0;">🐼 О себе!</h2>
  </div>
  <div style="flex: 1; min-width: 250px; color: #c9d1d9; font-size: 16px; line-height: 1.6;">
    <p style="margin: 0 0 15px 0;">
      Всем привет! Я <strong style="color: #4493f8;">Java-разработчик</strong> с большим опытом написания кода.
    </p>
    <p style="margin: 0 0 15px 0;">
      Мне нравится строить надёжные системы и разбираться в том, как они работают под капотом, <br>
      а если вдруг система полетела, в первую очередь мне всегда хочется найти истинную причину поломки и понять каким образом ее можно устранить за короткий промежуток времени.
    </p>
  </div>
  <div style="flex: 0 0 200px; display: flex; align-items: center; justify-content: center; min-width: 150px;">
    <img src="https://raw.githubusercontent.com/gfreee333/gfreee333/main/image/panda-hi.gif"
         style="max-width: 100%; height: auto; border-radius: 12px; border: 1px solid #30363d;" />
  </div>
  <!-- ===== БЛОК: МОЯ СПЕЦИАЛИЗАЦИЯ ===== -->
  <div style="display: block; width: 100%; box-sizing: border-box; margin: 20px 0; padding: 25px; background: #0d1117; border-radius: 12px; border: 1px solid #30363d;">
    <div style="width: 100%; border-bottom: 2px solid #4493f8; padding-bottom: 10px; margin-bottom: 18px;">
      <h2 style="color: #4493f8; margin: 0; text-align: center; font-size: 1.5em;">🕮 Моя специализация</h2>
    </div>  
    <ul style="list-style: none; padding: 0; margin: 0; width: 100%; color: #c9d1d9; font-size: 16px; line-height: 1.6;">
      <li style="padding: 12px 15px; margin-bottom: 10px; background: #161b22; border-radius: 8px; border-left: 3px solid #4493f8;">
        <strong style="color: #4493f8;">Специализация:</strong> Backend-разработка на языке Java
      </li>
      <li style="padding: 12px 15px; margin-bottom: 10px; background: #161b22; border-radius: 8px; border-left: 3px solid #f0883e;">
        <strong style="color: #f0883e;">Сейчас изучаю:</strong> Тонкости и особенности работы с Kubernetes
      </li>
      <li style="padding: 12px 15px; margin-bottom: 0; background: #161b22; border-radius: 8px; border-left: 3px solid #da3633;">
        <strong style="color: #da3633;">Образование:</strong> СНИУ им. Королева (Прикладная математика и Физика)
      </li>
    </ul>
  </div>
  <!-- ===== БЛОК: ТЕХНИЧЕСКИЙ STACK ===== -->
  <div style="flex: 0 0 100%; border-bottom: 2px solid #4493f8; padding-bottom: 10px; margin-bottom: 10px;">
    <h2 align="center" style="color: #4493f8; margin: 0;">⚒ Технический Stack</h2>
  </div>
<div style="display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; align-items: center; padding: 10px 0; width: 100%;">
...
<div style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center; padding: 8px 12px; background: #161b22; border-radius: 8px; border: 1px solid #30363d;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center; padding: 8px 12px; background: #161b22; border-radius: 8px; border: 1px solid #30363d;">
      ...
      <img src="https://raw.githubusercontent.com/gfreee333/gfreee333/main/image/mocikto.png" height="40" alt="Mocikto" />
  ...
  <!-- ===== БЛОК: КОНТАКТЫ ===== -->
  <div style="flex: 0 0 100%; border-bottom: 2px solid #4493f8; padding-bottom: 10px; margin-bottom: 10px; margin-top: 20px;">
    <h2 style="color: #4493f8; margin: 0; text-align: center;">✉ Мои контакты</h2>
  </div>
  <div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; align-items: center; width: 100%; padding: 15px 0;">
